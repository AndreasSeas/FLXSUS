...
pre23=pd.read_excel("FLNSUS2023_Pre_Filtered(temp).xlsx");
post23=pd.read_excel("FLNSUS2023_Post_Filtered(temp).xlsx")
...
fig.savefig('FLNSUS_2021.jpeg',dpi=600,bbox_inches='tight');
...
fig.savefig('FLNSUS_2022.jpeg',dpi=600,bbox_inches='tight');
...
fig.savefig('FLNSUS_2023.jpeg',dpi=600,bbox_inches='tight');
