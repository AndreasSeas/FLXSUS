...
# =============================================================================
# Get zip code for US participants
# =============================================================================

geolocator = geopy.Nominatim(user_agent='my-application')

latlon=pd.DataFrame(data=None,columns=['Latitude','Longitude','Survey',])

for i,dfi in enumerate(dflist):
    temp=dfi[['Latitude','Longitude']]
    temp['Survey']
    latlon=pd.concat([latlon,temp])
    

zipcodes = latlon.apply(get_zipcode, axis=1, geolocator=geolocator, lat_field='Lat', lon_field='Lon')

sys.exit()

# =============================================================================
# Load Participant zipcode data
# =============================================================================

name_zipcodes='/Users/as822/Library/CloudStorage/Box-Box/McIntyreLab_Andreas/Writing/W-Manuscript-LITTDisparity/LITT_Zip_Code_Data.csv'

df=pd.read_csv(name_zipcodes)
